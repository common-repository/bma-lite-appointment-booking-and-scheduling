...
= 1.4.1 =
* Fixed select time & date issue during booking
* Fixed working & break hour of employee during employee registration
* Fixed break hours during update data of employee
...
* Fixed designing issues on booking form
* Minor bug fixed

= 1.3.2 =
* Fixed an issue in Edit Appointment Form (regarding appointment status not showing)
* Fixed an issue in Customer Edit Form (regarding customer edit form not open)
* Minor bug fixed

= 1.3.1 = 
* Fixed an issue in Email Notification Section
* Minor bug fixed

= 1.3.0 = 
* Added Coupon Module Section
* Added Forms Module Section
* Minor bug fixed
...
= 1.2.0 =
* Minor bug fixed of Category and Service Section
* Added Shortcode section of Pro plugin

= 1.1.1 = 
* Minor Multisite issue fixed
